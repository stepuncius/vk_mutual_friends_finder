...
class FriendsGetter:
	...
	def get_friends(self, user_id):
		""" Gets user's friends by id of user given as string or int and returns friends as set

		I really have no idea how to write a test for it because we haven't immutable users.
		"""
